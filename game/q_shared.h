...
//
// per-level limits // SLART: THESE MUST BE KEPT CONSISTENT WITH src/client/ref.h
//
...
#ifndef M_PI
#define M_PI	3.14159265358979323846	// matches value in MSVC math.h
#endif

// SLART: Moved from q_shared.c
#ifndef RAD2DEG
...
#if !defined C_ONLY && !defined __linux__ && !defined __sgi && defined _M_IX86 // SLART64
