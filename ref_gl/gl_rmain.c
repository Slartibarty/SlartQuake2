...
void R_Register( void )
{
	...
	gl_round_down = ri.Cvar_Get ("gl_round_down", "0", 0); // SLART: This disables texture rounding
	...
	gl_texturemode = ri.Cvar_Get( "gl_texturemode", "GL_LINEAR_MIPMAP_LINEAR", CVAR_ARCHIVE ); // SLART: Was GL_LINEAR_MIPMAP_NEAREST
	...
	gl_ext_palettedtexture = ri.Cvar_Get( "gl_ext_palettedtexture", "0", CVAR_ARCHIVE ); // SLART: Was 1, I don't know if this helps
